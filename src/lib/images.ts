...
// - Retratos das faixas etárias: fotos originais do funil (CDN de imagens).
...
export const IMG = {
  ...
  age40: `${KIMG}/da8d49pjj5k66ed9hk40`,
  age50: `${KIMG}/da8d7ktb8qo00miqjvs0`,
  age60: `${KIMG}/da8d7tls703s73a2b6pg`,
  age70: `${KIMG}/da8d7tvb28ls73bu879g`,
} as const;
